...
def fpichemfunction(x, m, xi, kj, nj)
	(xi.to_f - x.to_f * sum_function(x, m, kj, nj))
end

def fpichemfunctionoveralpha(x, m, xi, kj, nj)
	alpha = 1.0
...
functions = ["chemfunction", "fpichemfunction", "fpichemfunctionoveralpha"]
